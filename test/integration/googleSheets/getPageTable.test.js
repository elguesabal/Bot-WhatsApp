...
/**
 * @author VAMPETA
 * @brief TESTA O METODO 'getPageTable' DA CLASSE GoogleSheets
*/
describe("Google Sheets - getPageTable", () => {
	...
	test("requisição feita corretamente", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, page);
	...
	test("requisição feita com 'idPhone' inválido (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable("id inválido", process.env.ID_SPREADSHEET_TEST, page);

		expect(typeof res).toBe("string");
	});

	test("requisição feita com 'idSpreadsheet' inexistente", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, "planilha inexistente", page);

		expect(res).toBeNull();
	});

	test("requisição feita com 'page' inexistente", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, "página inexistente");

		expect(res).toBeNull();
	});

	test("requisição feita com 'idPhone' inválido, 'idSpreadsheet' inexistente e 'page' inexistente", async () => {
		const res = await googleSheets.getPageTable("id inválido", "planilha inexistente", "página inexistente");
	...
	test("requisição passando 'idPhone' como undefined (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable(undefined, process.env.ID_SPREADSHEET_TEST, page);
	...
	test("requisição passando 'idPhone' como null (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable(null, process.env.ID_SPREADSHEET_TEST, page);
	...
	test("requisição passando 'idPhone' como objeto (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable({}, process.env.ID_SPREADSHEET_TEST, page);
	...
	test("requisição passando 'idPhone' como boolean (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable(true, process.env.ID_SPREADSHEET_TEST, page);
	...
	test("requisição passando 'idPhone' como number (deve retornar uma resposta normal, já que, o 'idPhone' serve para salvar erros)", async () => {
		const res = await googleSheets.getPageTable(42, process.env.ID_SPREADSHEET_TEST, page);

		expect(typeof res).toBe("string");
	});

	test("requisição passando 'idSpreadsheet' como undefined", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, undefined, page);

		expect(res).toBeNull();
	});

	test("requisição passando 'idSpreadsheet' como null", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, null, page);

		expect(res).toBeNull();
	});

	test("requisição passando 'idSpreadsheet' como objeto", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, {}, page);
	...
	test("requisição passando 'idSpreadsheet' como boolean", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, true, page);
	...
	test("requisição passando 'idSpreadsheet' como number", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, 42, page);

		expect(res).toBeNull();
	});

	test("requisição passando 'page' como undefined", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, undefined);

		expect(res).toBeNull();
	});

	test("requisição passando 'page' como null", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, null);

		expect(res).toBeNull();
	});

	test("requisição passando 'page' como objeto", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, {});
	...
	test("requisição passando 'page' como boolean", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, true);
	...
	test("requisição passando 'page' como number", async () => {
		const res = await googleSheets.getPageTable(process.env.ID_PHONE_TEST, process.env.ID_SPREADSHEET_TEST, 42);
